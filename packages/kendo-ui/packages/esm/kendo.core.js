import { packageMetadata, validatePackage, addWatermarkOverlayAndBanner } from './kendo.licensing.js';
...
(function($, window, undefined$1) {
    ...
    kendo.isPresent = (value) => value !== null && value !== undefined$1;
    kendo.isBlank = (value) => value === null || value === undefined$1;
    kendo.isEmpty = (value) => value.length === 0;
    kendo.isString = (value) => typeof value === 'string';
    kendo.isInteger = (value) => Number.isInteger(value);
    kendo.isNumeric = (value) => !isNaN(value - parseFloat(value));
    kendo.isDate = (value) => value && value.getTime;
    ...
    kendo.timezone = (function() {
        ...
        function findRule(utcTime, rules, zone) {
            ...
            if (!rules) {
                ...
                return [-1e6, 'max', '-', 'Jan', 1, [0, 0, 0], offset, '-'];
            }
...
export { __meta__, kendo$1 as default, fromESClass };
