...
import { fetchDiscover, PIVOT_CONFIGURATOR_ACTION, configuratorReducer, ConfiguratorNavigation } from '@progress/kendo-pivotgrid-common';
    ...
    var PivotConfiguratorV2 = Widget.extend({
        ...
        _targets: function() {
            ...
            var targetItemTemplate = ({ name, menuenabled }) => {
                    var chip = kendo.html.renderChip(TARGET_ITEM_TEMPLATE({ name}), $.extend({}, options, {
                        fillMode: "solid",
                        themeColor: "base",
                        rounded: "md",
                        removable: true,
