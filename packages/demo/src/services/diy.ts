...
export function addCategoryProductRef(data: any) {
    return request('blisscake/backend/diyCategoryProductRel/addDiyCategoryRelShopProduct', {
        method: 'POST',
        data,
    });
}
export function deleteCategoryProductRef(params: any) {
    return request('blisscake/backend/diyCategoryProductRel/deleteDiyCategoryRelShopProduct', {
        method: 'GET',
        params
    });
}
...
export function addCategoryGroupProductRef(data: any) {
    return request('blisscake/backend/diyCategoryProductRel/addGroupShopProduct', {
        method: 'POST',
        data,
    });
}