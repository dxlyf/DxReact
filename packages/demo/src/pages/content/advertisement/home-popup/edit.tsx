 ...
 */
 ...
 import { ADVERTISE_URL_TYPES,ADVERTISE_TYPE } from '@/common/constants/advertisement';
 ...
 let HomePopupEdit: React.FC<any> = (props) => {
   ...
   let onSaveUpdate = useCallback(
     (values: any) => {
       ...
       submitData.status=values.status // 默认禁用
       submitData.adviceType=ADVERTISE_TYPE.enums.value3.value
       ...
       result
         .then(() => {
           ...
           props.history.push('/content/advertisement/home-popup');
         })
         .catch(() => {
           setLoading(false);
         });
   ...
   return (
     <Card>
       <Form {...formLayout} form={form} onFinish={onSaveUpdate}>
         ...
         <Form.Item label="弹窗图片" name="advicePic" {...formItemProps}>
