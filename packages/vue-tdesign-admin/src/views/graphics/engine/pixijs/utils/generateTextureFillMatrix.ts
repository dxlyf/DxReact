 ...
 * @internal
 */
export function generateTextureMatrix(out: Matrix, style: any, shape: ShapePrimitive, matrix?: Matrix)
{
    ...
    if (!(style.fill) && sourceStyle.addressMode === 'clamp-to-edge')
    {
